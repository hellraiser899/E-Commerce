...
?>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>Artisan Alley infrastructure is manipulate with MVC Pattern and it's developed in a Raw PHP project. </p>
									<p> 
										<li> HTML5, CSS3 </li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>Kaithal,Haryana</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">70159XXXXX</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">abhishekbidhan3@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//aamroni.info" target="_blank"> Abhishek Bidhan</a>
						</p>
		...
		<div class="mobile-menu-container">
			<div class="mobile-menu-wrapper">
				...
				<div class="social-icons">
					<a href="facebook.com" class="social-icon" target="_blank">
						<i class="icon-facebook"></i>
					</a>
					<a href="https://www.linkedin.com/in/abhishek-bidhan-4a4373268/" class="social-icon" target="_blank">
						<i class="icon-linkedin"></i>
					</a>
					<a href="twitter.com" class="social-icon" target="_blank">
						<i class="icon-twitter"></i>
					</a>
				</div>
			</div>
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						...
						<div class="modal-body">
							...
							<p>Subscribe to the <b> Artisan Alley</b>  newsletter <br/> to receive timely updates from your favorite products.</p>
							<form action="" method="post">
								<div class="row">
